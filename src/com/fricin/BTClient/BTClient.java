...
public class BTClient extends Activity {
    ...
    private EditText Shaichuangpinlv;
    private EditText Fengjipinlv;
    private EditText Guoliaosudu;
    private EditText Qianshifengya;
    private EditText Houshifengya;
    private EditText Fengya;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Shaichuangpinlv = (EditText)findViewById(R.id.ShaichuangpinlvEdit);
        Fengjipinlv = (EditText)findViewById(R.id.FengjipinlvEdit);
        //Guoliaosudu = (EditText)findViewById(R.id.GuoliaosuduEdit);
        //Qianshifengya = (EditText)findViewById(R.id.QianshifengyaEdit);
        //Houshifengya = (EditText)findViewById(R.id.HoushifengyaEdit); 
       // Fengya = (EditText)findViewById(R.id.FengyaEdit);
    ...
    public void onSendButtonClicked(View v){
    	...
    	try{
    		...
    		String str = "0405";
    		//-----------------------------------
    		String bed_freq = Shaichuangpinlv.getText().toString();
    		int bed_len = bed_freq.length();
    		if(bed_len == 1){ 
    			str += "0";
    			str +=bed_freq;
    		}
    		else if(bed_len >=3){
    			str += bed_freq.charAt(bed_len-2);
    			str += bed_freq.charAt(bed_len-1);
    		}
    		else str +=bed_freq;
    		
    		//------------------------------------
    		String wind_freq = Fengjipinlv.getText().toString();
    		int wind_len = wind_freq.length();
    		if(wind_len == 1){ 
    			str += "0";
    			str +=wind_freq;
    		}
    		else if(wind_len >=3){
    			str += wind_freq.charAt(wind_len-2);
    			str += wind_freq.charAt(wind_len-1);
    		}
    		else str += wind_freq;
    		//-------------------------------------
    		String wind_pressure = Fengya.getText().toString();
    		int pressure_len = wind_pressure.length();
    		if(pressure_len == 1){ 
    			str += "0";
    			str +=wind_pressure;
    		}
    		else if(wind_len >=3){
    			str += wind_pressure.charAt(pressure_len-2);
    			str += wind_pressure.charAt(pressure_len-1);
    		}
    		else str += wind_pressure;
    		
    		//str += Shaichuangpinlv.getText().toString();
            //str += Fengjipinlv.getText().toString();
            //str += Guoliaosudu.getText().toString();
            //str += Qianshifengya.getText().toString();
            //str += Houshifengya.getText().toString();
            //str += Fengya.getText().toString();
            
            byte[] ZixuanParam = str.getBytes();
            
    		//byte[] bos = edit0.getText().toString().getBytes();
    		/*
    		byte[] bos = {0x03,0x05,0x08};
  ...
  /*  @Override
    ...
    public void onBaiCaiClicked(View v) throws IOException{
    ...
    public void onQinCaiClicked(View v) throws IOException{
    	OutputStream os = _socket.getOutputStream();
    	String str = "040601";
    	byte[] buff = str.getBytes();
    	os.write(buff);
    ...
    public void onFanQieClicked(View v) throws IOException{
    	OutputStream os = _socket.getOutputStream();
    	String str = "040602";
    	byte[] buff = str.getBytes();
    	os.write(buff);
